  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: 'p-0 transition-colors size-8 text-sm flex-1 flex items-center justify-center has-[button]:hover:!bg-accent/40 rounded-md has-[button]:hover:aria-selected:!bg-primary/40 has-[button]:hover:text-foreground has-[button]:hover:aria-selected:text-foreground',
        day_button: cn(
